  ...
  <div class="min-h-screen bg-gray-50">
    <UContainer class="py-8">
      <div class="max-w-4xl mx-auto">
        ...
        <UCard class="mb-8">
          <template #header>
            <h2 class="text-xl font-semibold">User Context</h2>
          </template>

          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <UButton v-for="user in users" :key="user.userId" :variant="selectedUser?.userId === user.userId ? 'solid' : 'outline'
              " @click="selectUser(user)" class="justify-start">
              {{ user.email }}
              <UBadge :color="getBadgeColor(user.userGroup)" class="ml-2">
                {{ user.userGroup }}
              </UBadge>
            </UButton>
          </div>
        ...
        <div class="grid gap-8">
          ...
          <UCard>
            <template #header>
              <div class="flex items-center justify-between">
                ...
                <UBadge color="gray" label="Flag Status: TBD" />
              </div>
            </template>
              ...
              <div class="p-6 bg-gradient-to-r from-slate-700 to-slate-900 rounded-lg text-white">
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-right">
                    ...
                    <div class="text-slate-300">per month</div>
                  </div>
                </div>
                ...
                <div class="mt-6">
                  <UButton color="white" variant="solid" size="lg" class="w-full md:w-auto">
                    Get Started
                  </UButton>
                </div>
              </div>
              ...
              <div
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-right">
                    ...
                    <div class="text-emerald-100 mt-1">per month</div>
                  </div>
                </div>
                ...
                <div class="mt-6 flex gap-3">
                  ...
                  <UButton color="white" variant="outline" size="lg" class="border-white/30 hover:bg-white/10">
                    Learn More
                  </UButton>
                </div>
              </div>
          ...
          <UCard>
            <template #header>
              <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold">2. A/B Testing Feature</h2>
                <UBadge color="gray" label="Variant: TBD" />
              </div>
            </template>
            ...
            <div class="space-y-4">
              ...
              <div class="bg-white p-12 rounded-lg border border-gray-200 text-center">
                ...
                <div class="flex justify-center gap-4 mb-8">
                  <UButton color="blue" size="xl" variant="solid" class="px-8">
                    Start Free Trial
                  </UButton>
                  <UButton color="gray" size="xl" variant="outline" class="px-8">
                    Schedule Demo
                  </UButton>
                </div>
              ...
              <div class="bg-gradient-to-br from-purple-600 to-purple-800 p-12 rounded-lg text-white">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div class="space-y-4">
                      <UButton color="white" size="xl" variant="solid" class="w-full text-purple-800 font-semibold">
                        Start Free Trial
                      </UButton>
                      <UButton color="purple" size="xl" variant="outline" class="w-full border-purple-300 text-white">
                        Schedule Demo
                      </UButton>
                    </div>
                    ...
                    <div class="bg-white/10 rounded-xl p-6 backdrop-blur-sm border border-white/20">
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="w-full bg-purple-700 rounded-full h-2">
                          <div class="bg-white h-2 rounded-full" style="width: 99%"></div>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                        ...
                        <div class="w-full bg-purple-700 rounded-full h-2">
                          <div class="bg-white h-2 rounded-full" style="width: 98%"></div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="bg-gradient-to-r from-gray-900 to-black p-12 rounded-lg text-white">
                <div class="max-w-4xl">
                  ...
                  <div class="flex gap-6 items-center">
                    <UButton color="white" size="xl" variant="solid" class="px-12 text-black font-medium">
                      Start Free Trial
                    </UButton>
                    <UButton color="gray" size="xl" variant="ghost" class="px-8 text-gray-300">
                      Schedule Demo →
                    </UButton>
                  </div>
              ...
              <div
                ...
                <div class="relative z-10">
                  ...
                  <div class="flex flex-col sm:flex-row justify-center gap-4 mb-8">
                    ...
                    <UButton color="white" size="xl" variant="solid"
